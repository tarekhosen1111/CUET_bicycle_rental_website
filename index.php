      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Get a chance to ride your favorite Bi-cycle.</h1>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user" aria-hidden="true"></i>100+</h2>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-calendar" aria-hidden="true"></i>500+</h2>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-bicycle" aria-hidden="true"></i>20+</h2>
            <p>Used Bicycle</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m"> 
          <div class="cell">
            <h2><i class="fa fa-bicycle" aria-hidden="true"></i>5+</h2>
            <p>New Bicycle</p>
          </div>
        </div>
      </div>
